...
namespace Identity.Api.Controllers
{
    ...
    public class UnidadesMediumController : Controller
    {
        ...
        [HttpGet("GetUnidadesMedidumPaginados")]
        public IActionResult GetUnidadesMedidumPaginados(
        int pagina = 1,
        ...
        string? estado = null)
        {
            try
            {
                ...
                var resultado = _iUnidades.GetUnidadesMedidumPaginados(pagina, pageSize, filtro, estado);
