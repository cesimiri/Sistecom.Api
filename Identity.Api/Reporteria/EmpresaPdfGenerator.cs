...
namespace Identity.Api.Reporteria
{
    ...
    {
        public static byte[] GenerarPdf(List<EmpresasCliente> empresas, string? correo)
        {
                ...
                container.Page(page =>
                {
                    ...
                    page.Content().Table(table =>
                    {
                        table.ColumnsDefinition(columns =>
                        {
                            ...
                            columns.RelativeColumn(3); // TipoCliente
                        ...
                        table.Header(header =>
                        {
                            ...
                            header.Cell().Text("Tipo de Cliente").Bold();
                        ...
                        foreach (var emp in empresas)
                        {
                            ...
                            table.Cell().Text(emp.TipoCliente);
                            //table.Cell().Text(emp.DireccionMatriz);
